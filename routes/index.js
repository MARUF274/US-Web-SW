...
router.get('/signup', function(req,res,next){
	res.render('main/signup', {title:"Signup Page"})
})
...
router.post('/signup',function(req,res,next){
	...
	if (!errors) {
		req.getConnection(function(err,connection){
			...
			var query = connection.query('insert into user (the_email, the_password) values ("'+v_email+'", "'+v_pass+'")',function(err,rows)
			{
				if(err)
				{
